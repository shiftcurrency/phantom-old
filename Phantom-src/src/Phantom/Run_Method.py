...
class Run_Method(object):
    ...
    def execute(self,postparams):
        ...
        if postparams['method'] == 'get_shiftbase':
            ...
            return self.res
        elif postparams['method'] == 'create_phantom_domain':
            self.res = phantom_ui.create_phantom_domain(postparams)
            return self.res
            ...
            return self.res
             ...
             return self.res
        elif postparams['method'] == 'get_indexed_domains':
            self.res = phantom_ui.get_indexed_domains(postparams)
            return self.res
