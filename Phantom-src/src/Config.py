...
class Config(object):
    ...
    def createArguments(self):
        ...
        self.parser.add_argument('--config_file', help='Path of config file', default="phantom.conf", metavar="path")
        ...
        self.parser.add_argument('--ui_port', help='Web interface bind port', default=53903, type=int, metavar='port')
        self.parser.add_argument('--ui_restrict', help='Restrict web access', default=False, metavar='ip', nargs='*')
        self.parser.add_argument('--open_browser', help='Open homepage in web browser automatically',
                                 nargs='?', const="default_browser", metavar='browser_name')
        self.parser.add_argument('--homepage', help='Web interface Homepage', default='1CQTfYmebR1bP75PCUata417NffWyL6AXf',
                                 metavar='address')
        ...
        self.parser.add_argument('--tor', help='enable: Use only for Tor peers, always: Use Tor for every connection', choices=["disable", "enable", "always"], default='disable')
        ...
        self.parser.add_argument('--version', action='version', version='Phantom %s r%s' % (self.version, self.rev))
    ...
    def parse(self, silent=False, parse_config=True):
        ...
        if silent:  # Restore original functions
            if self.parser.exited and self.action == "main":  # Argument parsing halted, don't start Phantom with main action
                self.action = None
