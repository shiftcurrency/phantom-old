        ...
        if user_created:
            ...
            inject_html = """
                ...
                <script>
                 ...
                 hello_message+= "<small>This site allows you to browse Phantom content, but if you want to secure your account <br>"
                 hello_message+= "and help to make a better network, then please run your own <a href='https://github.com/HelloPhantom/Phantom' target='_blank'>Phantom client</a>.</small>"
                 setTimeout(function() {
