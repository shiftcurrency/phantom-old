...
class TestConfig:
    def testParse(self):
        # Defaults
        config_test = Config.Config("phantom.py".split(" "))
        ...
        config_test = Config.Config("phantom.py --debug --debug_socket --ui_password hello".split(" "))
        config_test.parse(silent=True, parse_config=False)
        ...
        # More complex test
        args = "phantom.py --unknown_arg --debug --debug_socket --ui_restrict 127.0.0.1 1.2.3.4 "
